    ...
    <div className="space-y-8 animate-fade-in pb-16">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        ...
        <div className="lg:col-span-4 space-y-6">
          ...
          {/* Quick Info Box */}
          <div className="card-panel p-6 bg-gradient-to-br from-indigo-900 via-indigo-950 to-slate-950 text-white rounded-3xl shadow-xl relative overflow-hidden border border-indigo-800/40">
            ...
            <div className="flex items-center gap-2.5 mb-3">
              ...
              <h4 className="text-sm font-extrabold">Answer Key Auto-Matching</h4>
            </div>
            <p className="text-xs text-indigo-200 leading-relaxed font-medium">
              Separate answer key sheets can be linked to question papers to automatically verify solutions and identify discrepancies.
            </p>
            <button
              onClick={() => navigate('/answer-keys')}
              className="mt-5 w-full inline-flex items-center justify-center gap-2 text-xs font-bold text-white bg-indigo-600 hover:bg-indigo-500 px-4 py-2.5 rounded-xl transition-all shadow-md"
            >
